      ...
      <div className="grid gap-6 md:grid-cols-2">
        ...
        {isAdmin && (
          <>
            ...
            <Card 
              className="cursor-pointer hover:shadow-lg transition-all border-indigo-100 hover:border-indigo-300 group"
              onClick={() => navigate('/manual-installation')}
            >
              <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2">
                <CardTitle className="text-xl font-semibold text-indigo-900">
                  Manual Restoration Guide
                </CardTitle>
                <Package className="h-6 w-6 text-indigo-500 group-hover:scale-110 transition-transform" />
              </CardHeader>
              <CardContent>
                <CardDescription className="mt-2 text-sm leading-relaxed">
                  Download system assets (SQL & Code) and follow a step-by-step guide to manually restore or migrate the system to a live server.
                </CardDescription>
